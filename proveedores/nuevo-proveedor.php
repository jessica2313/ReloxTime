					...
					<div class="row" style="margin-top: 15px;margin-bottom: 15px; margin-right: 0px; margin-left: 0px;">
                        <div class="col-12">
                            <div class="card m-b-20">
                                <div class="card-body">
                                    <h4 class="mt-10 header-title" style="padding-bottom: 15px;">Registrar Proveedores</h4>
                                    ...
                                    <div class="form-group row">
                                        <label for="example-tel-input" class="col-sm-2 col-form-label">Teléfono</label>
                                        <div class="col-sm-10">
